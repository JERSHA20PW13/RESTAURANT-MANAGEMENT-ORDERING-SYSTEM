...
(
	...
	Contact CHAR(20) DEFAULT NULL UNIQUE,
	EmailId VARCHAR(50) DEFAULT NULL UNIQUE,
	RestName VARCHAR(100) NOT NULL,
...
# DROP TABLE DELIVERY_BOY_DETAILS;
...
SELECT 
    *, count(*) as No_Of_Times_Booked
FROM
    Tables
        LEFT OUTER JOIN
    Booking USING (TableNum) group by (TableNum);
...
BEGIN
    ...
    DECLARE CONTINUE HANDLER FOR SQLSTATE '02000' SET NoDatafound = 1;  #no rows found
	DECLARE CONTINUE HANDLER FOR SQLSTATE '23000' SET NoDatafound = 1;  #integrity constraint violation
